    ...
    <div style={styles.wrapper}>
      ...
      <div style={styles.card}>
        ...
        <div style={styles.desRow}>
          ...
          <span style={styles.value}>Offering 15 Grade B kampung eggs. Bought a tray of 30 a few days ago, won't be able to finish them all before the expiry date. Stored in the fridge.</span>
        </div>
